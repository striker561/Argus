...
class APIResponse:
    ...
    def success(
        ...
        return JSONResponse(
            content=jsonable_encoder({"msg": msg, "data": data}),
            status_code=status,
        )
    ...
    def error(
        ...
        return JSONResponse(
            content={"msg": msg, "errors": errors if errors is not None else []},
            status_code=status,
        )
    ...
    def validation(
        ...
        return JSONResponse(content={"msg": msg, "errors": errors}, status_code=422)
